...
const useGlobalContexts = () => {
  ...
  useEffect(() => {
    ...
    adobeDataLayer.push(dl => {
      dl.addEventListener('adobeDataLayer:change', handleStorefrontUpdate, {
        path: 'storefront-instance-context',
      });
    });
    return () => {
      adobeDataLayer.push(dl => {
        dl.removeEventListener('adobeDataLayer:change', handleStorefrontUpdate);
      });
    };
  }, []);
  ...
  useEffect(() => {
    ...
    adobeDataLayer.push(dl => {
      dl.addEventListener('adobeDataLayer:change', handleExtensionUpdate, {
        path: 'magento-extension-context',
      });
    });
    return () => {
      adobeDataLayer.push(dl => {
        dl.removeEventListener('adobeDataLayer:change', handleExtensionUpdate);
      });
    };
  }, []);
  ...
  useEffect(() => {
    ...
    adobeDataLayer.push(dl => {
      dl.addEventListener('adobeDataLayer:change', handleShopperUpdate, {
        path: 'shopper-context',
      });
    });
    return () => {
      adobeDataLayer.push(dl => {
        dl.removeEventListener('adobeDataLayer:change', handleShopperUpdate);
      });
    };
  }, []);
  ...
  useEffect(() => {
    ...
    adobeDataLayer.push(dl => {
      dl.addEventListener('adobeDataLayer:change', handleShoppingCartUpdate, {
        path: 'shopping-cart-context',
      });
    });
    return () => {
      adobeDataLayer.push(dl => {
        dl.removeEventListener(
