...
module.exports = targets => {
  ...
  builtins.envVarDefinitions.tap(defs => {
    ...
    targets.of('@magento/peregrine').talons.tap(talons => {
      ...
      talons.Checkout.useFlow.wrapWith(`${myName}/lib/collector/wrappers/wrapUseFlow`);
      ...
      talons.MiniCart.useMiniCart.wrapWith(
        `${myName}/lib/collector/wrappers/wrapUseProductMini`,
      );
      talons.CartPage.ProductListing.useProduct.wrapWith(
        `${myName}/lib/collector/wrappers/wrapUseProductCart`,
      );
      talons.SignIn.useSignIn.wrapWith(`${myName}/lib/collector/wrappers/wrapUseSignIn`);
