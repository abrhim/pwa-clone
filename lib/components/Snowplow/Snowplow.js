...
!(function o(i, c, s) {
...
})(
    {
            ...
            function(e, t, n) {
                ...
                t.exports = function(e, t) {
                    ...
                    return (
                        ...
                        i.test(e) || !o.test(e) || (null != t && e in Object(t))
                    );
                };
            },
        ...
        156: [
            function(e, t, n) {
                ...
                function j(e) {
                    return (
                        !(!Array.isArray(e) || 2 !== e.length) &&
                        !!k(e[0]) && (Array.isArray(e[1]) ? l(e[1], S) : S(e[1]))
                    );
                }
                function O(e) {
                    return C(e) || j(e);
        ...
        157: [
            ...
            { "./contexts": 156, "./payload": 158, "uuid": 160 },
        ],
        158: [
            function(e, t, n) {
                Object.defineProperty(n, "__esModule", { value: !0 });
        ...
        164: [
            ...
            { "./lib/bytesToUuid": 162, "./lib/rng": 163 },
        ],
        165: [
            function(e, t, n) {
                var i = e("./lib/rng"),
        ...
        166: [
            ...
            { "./lib/helpers": 172, "lodash/isFunction": 133 },
        ],
        167: [
            function(e, t, n) {
        ...
        174: [
            ...
            { "./lib/helpers": 172, "lodash/isUndefined": 141 },
        ],
        175: [
            function(e, t, n) {
                !(function() {
                ...
                !(function() {
                    ...
                    (void 0 !== n ? n : this).Tracker = function(e, t, n, f, r) {
                        ...
                        var m,
                            ...
                            C = pt(!0, function(e) {
                                !(function(e) {
                                    ...
                                    t = !!h && !!it.cookie(h);
                                    if ((J || t) && "none" != ne)
                                        return "localStorage" == ne
                                            ? (at.attemptWriteLocalStorage(r, ""),
                                                at.attemptWriteLocalStorage(a, ""))
                                            : ("cookie" != ne && "cookieAndLocalStorage" != ne) ||
                                            (it.cookie(r, "", -1, K, H),
                                                it.cookie(a, "", -1, K, H));
                                    "0" === c
                                        ? ((b = p),
                                    o || "none" == ne || (l++, (d = f), (b = vt.v4())),
                                        (se = l))
                                        : new Date().getTime() - ie > 1e3 * Q &&
                                        ((b = vt.v4()), se++);
                                    e.add("vp", ct.detectViewport()),
                                        e.add("ds", ct.detectDocumentSize()),
                                        e.add("vid", se),
                                        e.add("sid", b),
                                        e.add("duid", s),
                                        e.add("uid", w),
                            ...
                            J =
                                ...
                                r.respectDoNotTrack && ("yes" === W || "1" === W),
                            Y = r.hasOwnProperty("cookieLifetime")
                                ? r.cookieLifetime
                                : 63072e3,
                            Q = r.hasOwnProperty("sessionCookieTimeout")
                            ...
                            Z =
                                !(X || !r.hasOwnProperty("forceUnsecureTracker")) &&
                            ...
                            te =
                                ...
                                (at.warn(
                                    ...
                                    r.useCookies),
                            ne = r.hasOwnProperty("stateStorageStrategy")
                            ...
                            ye = !1,
                            _e = !1,
                            be = { enabled: !1, installed: !1, configurations: {} },
                            we = {};
                        for (var ke in (r.hasOwnProperty("discoverRootDomain") &&
                        ...
                        ve.geolocation && He(),
                            ...
                            C.setAppId(B),
                            C.setPlatform(z),
                            C.setTimezone(ct.detectTimezone()),
                            C.addPayloadPair("lang", re),
                            C.addPayloadPair("cs", $),
                            ae))
                            Object.prototype.hasOwnProperty.call(ae, ke) &&
                            ("res" === ke || "cd" === ke || "cookie" === ke
                                ? C.addPayloadPair(ke, ae[ke])
                                : C.addPayloadPair("f_" + ke, ae[ke]));
                        function Ae() {
                            (L = ot.fixupUrl(
                                I.domain,
                                E.location.href,
                                at.getReferrer(),
                            ))[1] !== N && (F = at.getReferrer(N)),
                                (M = at.fixupDomain(L[0])),
                                (N = L[1]);
                        }
                        function xe() {
                            ...
                            this.href &&
                            (this.href = at.decorateQuerystring(
                                this.href,
                                "_sp",
                                _ + "." + e,
                            ));
                        ...
                        function Se(e) {
                            for (var t = 0; t < I.links.length; t++) {
                                ...
                                e(n) &&
                                (at.addEventListener(n, "click", xe, !0),
                                    at.addEventListener(n, "mousedown", xe, !0),
                        ...
                        function ze(e, t, n) {
                            "localStorage" == ne
                                ? at.attemptWriteLocalStorage(e, t, n)
                                : ("cookie" != ne && "cookieAndLocalStorage" != ne) ||
                                it.cookie(e, t, n, K, H);
                        }
                        function Ue() {
                                        ...
                                        if (r) {
                                            for (
                                                ...
                                                var c = e[i],
                                                    s = {};
                                                (s.experimentId = c),
                                                    (s.isActive = at.isValueInArray(e[i], o));
                        ...
                        function Re() {
                            return (
                                null == f.pageViewId && (f.pageViewId = vt.v4()), f.pageViewId
                            );
                        }
                        function qe(e, t) {
                            var n;
                        ...
                        function We(e, t, n, r) {
                            Ae(),
                            _e &&
                            ((ye && null != f.pageViewId) || (f.pageViewId = vt.v4())),
                                (_e = !0),
                                (G = I.title),
                                (d = e);
                            ...
                            if (be.enabled && !be.installed) {
                                ...
                                Object.prototype.hasOwnProperty.call(c, "hasSupport")
                                    ? at.addEventListener(I, s, Ie, { passive: !0 })
                                    : at.addEventListener(I, s, Ie),
                                    Le(),
                                    at.addEventListener(I, "click", Ie),
                                    at.addEventListener(I, "mouseup", Ie),
                                    at.addEventListener(I, "mousedown", Ie),
                                    at.addEventListener(I, "mousemove", Ie),
                                    at.addEventListener(E, "scroll", Ee),
                                    at.addEventListener(I, "keypress", Ie),
                                    at.addEventListener(I, "keydown", Ie),
                                    at.addEventListener(I, "keyup", Ie),
                                    at.addEventListener(E, "resize", Ie),
                                    at.addEventListener(E, "focus", Ie),
                                    at.addEventListener(E, "blur", Ie);
                            }
                            if (be.enabled && (q || i))
                        ...
                        function Xe(t) {
                            ...
                            e
                                ? at.addEventListener(I, r + "visibilitychange", function e() {
                        ...
                        Pe(),
                            (A = "none" != ne && !!Te("ses")),
                            (x = Ue())[1] ? (_ = x[1]) : ((_ = vt.v4()), (x[1] = _)),
                            (b = x[6]),
                        A || (x[3]++, (b = vt.v4()), (x[6] = b), (x[5] = x[4])),
                        "none" != ne &&
                        (Ne(),
                            (x[4] = Math.round(new Date().getTime() / 1e3)),
                            x.shift(),
                            Fe.apply(null, x)),
                        r.crossDomainLinker && Se(r.crossDomainLinker);
                        var et =
                        ...
                        return (
                            (O.getDomainSessionIndex = function() {
                                ...
                                (O.newSession = function() {
                                    ...
                                    "0" === n
                                        ? ((b = s),
                                    "none" != ne && (o++, (c = i), (b = vt.v4())),
                                        (se = o),
                                        Ne())
                                        : ((b = vt.v4()), se++),
                                    "none" != ne && (Fe(r, a, se, e, c, b), Ne()),
                                        (ie = new Date().getTime());
                                }),
                                ...
                                (O.setCookieDomain = function(e) {
                                    at.warn("setCookieDomain" + tt + "cookieDomain"),
                                        (H = at.fixupDomain(e)),
                                        Pe();
                                }),
                                ...
                                (O.setSessionCookieTimeout = function(e) {
                                    at.warn(
                                        "setSessionCookieTimeout" + tt + "sessionCookieTimeout",
                                    ),
                                        (Q = e);
                                }),
                                ...
                                (O.enableLinkClickTracking = function(e, t, n, r) {
                                    f.hasLoaded
                                        ? (le.configureLinkClickTracking(e, t, n, r),
                                ...
                                (O.encodeBase64 = function(e) {
                                    at.warn("encodeBase64" + tt + "encodeBase64"),
                                        C.setBase64Encoding(e);
                                }),
                                (O.flushBuffer = function() {
                                    pe.executeQueue();
                                }),
                                (O.enableGeolocationContext = He),
                                ...
                                (O.trackTrans = function() {
                                    Xe(function() {
                                        !(function(e, t, n, r, a, o, i, c, s, u, l) {
                                            ...
                                            ue.transaction.orderId,
                                            ue.transaction.affiliation,
                                            ue.transaction.total,
                                            ue.transaction.tax,
                                            ue.transaction.shipping,
                                            ue.transaction.city,
                                            ue.transaction.state,
                                            ue.transaction.country,
                                            ue.transaction.currency,
                                            ue.transaction.context,
                                            ue.transaction.tstamp,
                                        );
