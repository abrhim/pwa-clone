...
import { CART_CONTENTS_KEY, USER_VIEW_HISTORY_KEY } from '../constants';
...
export default () => {
  ...
  const handleProductPageView = () => {
    ...
    try {
      let viewHistory = JSON.parse(localStorage.getItem(USER_VIEW_HISTORY_KEY));
      // might be null
  ...
  // format = [{"date":"2021-03-18T21:32:33.573Z","items":["WJ03-M-Red"]}]
