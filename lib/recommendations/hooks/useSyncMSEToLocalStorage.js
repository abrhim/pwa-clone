...
export default () => {
  ...
  // };
  const recsHandler = args => console.log(args);
  ...
  useEffect(() => {
    ...
    // TODO: remove me
    mse.subscribe.recsItemClick(recsHandler);
    mse.subscribe.recsRequestSent(recsHandler);
    mse.subscribe.recsResponseReceived(recsHandler);
    mse.subscribe.recsUnitRender(recsHandler);
    mse.subscribe.recsUnitView(recsHandler);
    ...
    return () => {
      ...
      // TODO: remove me
      mse.unsubscribe.recsItemClick(recsHandler);
      mse.unsubscribe.recsRequestSent(recsHandler);
      mse.unsubscribe.recsResponseReceived(recsHandler);
      mse.unsubscribe.recsUnitRender(recsHandler);
      mse.unsubscribe.recsUnitView(recsHandler);
    };
  }, []);
