...
module.exports = targets => {
  ...
  builtins.envVarDefinitions.tap(defs => {
    ...
    targets.of('@magento/peregrine').talons.tap(talons => {
        ...
        talons.Checkout.useOverview.wrapWith(`${myName}/lib/wrappers/wrapUseCheckoutOverview`);
        talons.ProductFullDetail.useProductFullDetail.wrapWith(`${myName}/lib/wrappers/wrapUseProductFullDetail`);
        talons.MiniCart.useMiniCart.wrapWith(`${myName}/lib/wrappers/wrapUseProductMini`);
        talons.CartPage.ProductListing.useProduct.wrapWith(`${myName}/lib/wrappers/wrapUseProductCart`);
        talons.SignIn.useSignIn.wrapWith(`${myName}/lib/wrappers/wrapUseSignIn`);
        talons.MyAccount.useMyAccount.wrapWith(`${myName}/lib/wrappers/wrapUseMyAccount`);
        return talons;
    });
  });
};